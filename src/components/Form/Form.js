...
class Form extends Component {
  ...
  submitHandler() {
    ...
    const userExist = this.props.users.find(
        ...
        <div className="body-input">
          ...
          <div>
            <input
              ...
              onChange={(event) =>
                this.inputChangeHandler(event.target.value, "username")
              }
            />
            <input
              type="password"
              ...
              onChange={(event) =>
                this.inputChangeHandler(event.target.value, "password")
              }
            />
          </div>
          {this.state.error ? (
            <span className="error-style">{this.state.error}</span>
          ) : null}
